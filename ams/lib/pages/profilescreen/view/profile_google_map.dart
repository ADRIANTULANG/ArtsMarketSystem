...
class ProfileGoogleMapView extends GetView<ProfileViewController> {
  const ProfileGoogleMapView({super.key});
        ...
        children: [
              ...
              child: Obx(
                () => ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return InkWell(
                      onTap: () {
                        controller.address_selected =
                            controller.placesList[index].placename;
                        controller.ontap_GoogleMap(
          ...
          InkWell(
            onTap: () async {
              ...
              controller.textaddressname.text = controller.address_selected;
              controller.latitude = controller.latitude_selected.toString();
              controller.longitude = controller.longitude_selected.toString();
              Get.back();
            },
            child: Container(
              height: 10.h,
